...
var canDrive = true;
if (age >= 16){
  console.log ("canDrive is true");
} else if (age < 16){
  console.log ("canDrive is false");
}
...
//function greeter(name,number){
  console.log('Hi! My name is Dayatra" + "I'm 43 years old');
}
greeter ('Hi! My name is Dayatra and I'm 43 years old')
